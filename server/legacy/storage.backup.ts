...
try {
  ...
  if (existingUsers.length === 0) {
    ...
    console.log(`[DatabaseStorage] Usuário de exemplo criado com ID: ${newUser.id}`);
    
    // Adiciona categorias de exemplo
    const demoCategories = [
      { userId: newUser.id, name: 'Alimentação', type: 'expense', icon: '🍔', color: '#FF6B6B', createdAt: new Date(), updatedAt: new Date() },
      { userId: newUser.id, name: 'Transporte', type: 'expense', icon: '🚗', color: '#2196F3', createdAt: new Date(), updatedAt: new Date() },
      { userId: newUser.id, name: 'Lazer', type: 'expense', icon: '🎮', color: '#9C27B0', createdAt: new Date(), updatedAt: new Date() },
      { userId: newUser.id, name: 'Salário', type: 'income', icon: '💰', color: '#4CAF50', createdAt: new Date(), updatedAt: new Date() },
      { userId: newUser.id, name: 'Freelance', type: 'income', icon: '💼', color: '#FF9800', createdAt: new Date(), updatedAt: new Date() }
    ];
